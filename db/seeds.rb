...
# cat = User.find_or_create_by(username: "cat", password_digest: "password1", profile_picture: "../client/public/assets/IMG_8571.jpg", profile_bio: "eating food all the time nom nom nom!")
# cooper = User.find_or_create_by(username: "cooper", password_digest: "password1", profile_picture: "../client/public/assets/IMG_5600.jpeg", profile_bio: "hi!! I love car rides! Especially to restaurants!")
